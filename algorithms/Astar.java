...
public class Astar {
    ...
    void updateNode(Node s1, Node s2){
        if((s1.g + cost(s1,s2)) < s2.g){
            ...
            //if(s2.status.equals("0")) s2.closed=true;
            exploredNodeCount++;
            s2.isExplored=true;
            ...
            switch(heuristicCode){
                ...
                case 4:
                    ...
                    break;
                case 5:
                    s2.h = heuristics.heuristicFive(s2, map[goal.y][goal.x]);
                    break;
                case 6:
                    s2.h = heuristics.heuristicSix(s2, map[goal.y][goal.x]);
                    break;
                default:
                    s2.h=0;
                    break;
    ...
    double cost(Node s1, Node s2){
        ...
        if(Math.abs(s1.x-s2.x)+Math.abs(s1.y-s2.y)==1){
